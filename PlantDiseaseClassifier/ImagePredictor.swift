...
class ImagePredictor {
    ...
    static func createImageClassifier() -> VNCoreMLModel {
        ...
        let imageClassifierWrapper = try? PlantClassifier(configuration: defaultConfig)
    ...
    func makePredictions(for photo: UIImage, completionHandler: @escaping ImagePredictionHandler) throws {
        ...
        print("Successfullty Create ImageClassificationRequest")
        ...
        print("Starting ImageClassificationRequest")
